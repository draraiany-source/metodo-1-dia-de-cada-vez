...
Future<void> main() async {
  ...
  runZonedGuarded(() async {
    ...
    // Última rede de segurança: se algo escapar de todos os try/catch
    // acima e a zona capturar antes de runApp() ser chamado, ainda assim
    // exibimos uma tela legível em vez de deixar a página em branco.
