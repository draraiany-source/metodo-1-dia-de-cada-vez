...
/// Aqui as listas usam os seeds; conecte ao Firestore para produção.
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            ...
            _crudList(
                context,
                SeedData.workouts.map((w) => w.title).toList(),
                'treino'),
            _crudList(context,
                SeedData.recipes.map((r) => r.title).toList(), 'receita'),
            _crudList(
                context,
                SeedData.challenges.map((c) => c.title).toList(),
                'desafio'),
          ],
        ),
      ),
