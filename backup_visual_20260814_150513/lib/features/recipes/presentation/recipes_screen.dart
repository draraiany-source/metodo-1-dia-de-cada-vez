...
class _RecipesScreenState extends ConsumerState<RecipesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final navIndex = indexForLocation(GoRouterState.of(context).uri.path);
                ...
                children: [
                  Center(
                    child: (recipe.photoUrl == null || recipe.photoUrl!.isEmpty)
                        ...
                        : CachedNetworkImage(
                            ...
                            width: double.infinity,
                            height: 140,
                            errorWidget: (_, __, ___) => Text(recipe.emoji,
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: const Text('⭐ Receita recomendada para hoje',
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      '${recipe.durationMin} min • ${recipe.kcal} kcal • ${recipe.difficulty} • ${recipe.category}',
                      style: const TextStyle(
...
class _EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          LiliMascot(pose: MascotePose.triste, height: searching ? 90 : 140),
