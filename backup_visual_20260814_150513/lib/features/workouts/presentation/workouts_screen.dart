        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              const LiliMascot(pose: MascotePose.halteres, height: 90),
            ],
          ),
        ),
      ),
            ...
            children: [
              ...
              PressableScale(
                ...
                child: Icon(
                  ...
                  color:
                      isFavorite ? AppColors.secondary : AppColors.textTertiary,
                  size: 22,
                ),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          LiliMascot(
              pose: MascotePose.triste, height: searching ? 90 : 140),
