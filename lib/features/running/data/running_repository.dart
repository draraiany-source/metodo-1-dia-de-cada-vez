...
class RunningRepository {
  ...
  static const _localKeyPrefix = 'running_sessions_local_';

  String _localKey(String userId) => '$_localKeyPrefix$userId';
  ...
  Future<void> save(String userId, RunningSession session) async {
    ...
    list.add(jsonEncode({...session.toMap(), 'userId': userId}));
  ...
  Future<List<RunningSession>> fetchAll(String userId) async {
    ...
    for (final s in raw) {
      try {
        ...
        final owner = m['userId'] as String?;
