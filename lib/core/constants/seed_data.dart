...
class SeedData {
  ...
  static const List<Workout> workouts = [
    ...
    Workout(
      ...
      photoUrl: AppAssets.illustPlanoTreinoPersonal,
    ),
    Workout(
      id: 'pernas_aco',
      title: 'Pernas de Aço',
      ...
      photoUrl: AppAssets.illustKitTreino,
    ),
    Workout(
      id: 'bracos_definidos',
      ...
      photoUrl: AppAssets.illustHalter,
    ),
    Workout(
      id: 'costas_postura',
    ...
    Workout(
      ...
      photoUrl: AppAssets.illustTreinoChecklistDark,
    ),
    ...
    Workout(
      ...
      photoUrl: AppAssets.illustCorrida,
    ),
    Workout(
      id: 'caminhada_queima',
      ...
      photoUrl: AppAssets.illustCorridaGpsApp,
    ),
    Workout(
      id: 'bike_indoor',
      ...
      photoUrl: AppAssets.illustCorridaGpsDark,
    ),
    Workout(
      id: 'cardio_casa',
      ...
      photoUrl: AppAssets.illustHomePrincipal,
    ),
    ...
    Workout(
      ...
      photoUrl: AppAssets.illustMeuPlanoSemanal,
    ),
    Workout(
      id: 'gluteos_faixa',
    ...
    Workout(
      ...
      photoUrl: AppAssets.illustCalendarioTreinos,
    ),
  ];
  ...
  /// Catálogo priorizado pelo nível e objetivo (mesma lógica da aba Treinos).
  static List<Workout> recommendedPool({
    required String nivelLabel,
    required String boostTag,
  }) {
    var list = workouts
        .where((w) => w.level == nivelLabel || w.level == 'Todos os níveis')
        .toList();
    if (list.isEmpty) list = List.of(workouts);
    list.sort((a, b) {
      final aBoost = a.tags.contains(boostTag) ? 0 : 1;
      final bBoost = b.tags.contains(boostTag) ? 0 : 1;
      return aBoost.compareTo(bBoost);
    });
    return list;
  }

  /// Treino destacado do dia — rotaciona dentro do pool recomendado.
  static Workout dailyRecommended({
    required String nivelLabel,
    required String boostTag,
    DateTime? when,
  }) {
    final pool = recommendedPool(nivelLabel: nivelLabel, boostTag: boostTag);
    final day = when ?? DateTime.now();
    return pool[day.weekday % pool.length];
  }
}
